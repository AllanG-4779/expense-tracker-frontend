      ...
      <div className="flex md:flex-row flex-col gap-10  p-5 h-full">
        <div className="flex flex-col gap-3 md:flex-8/12">
          ...
          <div className="flex-1/2">
            {" "}
            <TableComponent
              transactions={appUserContext
                .transactions!.filter((each) => {
        ...
        <div className="flex flex-col gap-5  flex-4/12 ">
          <div className="flex gap-2 md:gap-5 items-center flex-wrap justify-between">
            <div className="flex flex-col gap-2">
              <p className="font-bold text-slate-500">Month</p>
              <select
                name="month"
                id=""
                className="rounded-md outline-none border-none flex-1/2 border-gray-300"
                value={month}
                onChange={(e) => {
            ...
            <div className="flex gap-2 items-center flex-col">
              <p className="font-bold text-slate-500">Year</p>
              <select
                name="year"
                value={year}
                id=""
            ...
            <div className="flex gap-2 items-center flex-col">
              <p className="font-bold text-slate-500"> Account</p>
              <select
