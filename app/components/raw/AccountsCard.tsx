...
const AccountsCard: React.FC<{
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-4 flex flex-col gap-3  max-w-full md:min-w-3/12 mb-4">
      ...
      <div>
        <button className="p-1  rounded-md w-full bg-[#dc4b3e] text-white font-semibold hover:bg-[#dc4b3e]/80 transition duration-200 ease-in-out cursor-pointer">
          View Transactions
        </button>
      </div>
    </div>
